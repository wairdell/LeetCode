...
public class UniquePathsII {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(impl.uniquePathsWithObstacles(input));//2

        input = new int[][]{
                new int[]{0,1},
                new int[]{0,0}
        };
        System.out.println(impl.uniquePathsWithObstacles(input));//1

        input = new int[][]{
                new int[]{0,0},
                new int[]{0,1}
        };
        System.out.println(impl.uniquePathsWithObstacles(input));//0
