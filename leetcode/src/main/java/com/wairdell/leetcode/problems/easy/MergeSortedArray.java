...
public class MergeSortedArray {
    ...
    public static void main(String[] args) {
        ...
        MergeSortedArray.ImplNew mergeSortedArray = new MergeSortedArray.ImplNew();
        mergeSortedArray.merge(nums1, 3, new int[]{2, 5, 6}, 3);
        System.out.println("result = " + Arrays.toString(nums1));//[1, 2, 2, 3, 5, 6]

        nums1 = new int[]{1};
        mergeSortedArray.merge(nums1, 1, new int[]{}, 0);
        System.out.println("result = " + Arrays.toString(nums1));//[1]
        ...
        mergeSortedArray.merge(nums1, 1, new int[]{1, 2, 3, 5, 6}, 5);
        System.out.println("result = " + Arrays.toString(nums1));//[1, 2, 3, 4, 5, 6]
    }
