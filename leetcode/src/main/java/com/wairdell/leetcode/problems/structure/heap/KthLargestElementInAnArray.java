package com.wairdell.leetcode.problems.structure.heap;

import java.util.Random;

/**
 * date   : 2024/4/12 13:57
 * desc   : 数组中的第K个最大元素 https://leetcode.cn/problems/Kth-Largest-Element-In-An-Array/description/
 */
public class KthLargestElementInAnArray {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(impl2.findKthLargest(new int[]{2, 1}, 1));//2
        System.out.println(impl2.findKthLargest(new int[]{1, 2, 3, 4, 5, 6}, 1));//6
    }
    ...
    static class PartitionImpl {
        ...
        public int[] partition(int[] nums, int l, int r) {
            int j = new Random().nextInt(r - l + 1) + l;
            int pivot = nums[j];
