 ...
 * desc   : 分发饼干 https://leetcode.cn/problems/assign-cookies/
 */
public class AssignCookies {
    ...
    public static void main(String[] args) {
        System.out.println("result = " + new AssignCookies().findContentChildren(new int[]{1, 2, 3}, new int[]{1, 1}));
        System.out.println("result = " + new AssignCookies().findContentChildren(new int[]{1, 2}, new int[]{1, 2, 3}));
        System.out.println("result = " + new AssignCookies().findContentChildren(new int[]{1, 2}, new int[]{1, 2, 3}));
        System.out.println("result = " + new AssignCookies().findContentChildren(new int[]{262, 437, 433, 102, 438, 346, 131, 160, 281, 34, 219, 373, 466, 275, 51, 118, 209, 32, 108, 57, 385, 514, 439, 73, 271, 442, 366, 515, 284, 425, 491, 466, 322, 34, 484, 231, 450, 355, 106, 279, 496, 312, 96, 461, 446, 422, 143, 98, 444, 461, 142, 234, 416, 45, 271, 344, 446, 364, 216, 16, 431, 370, 120, 463, 377, 106, 113, 406, 406, 481, 304, 41, 2, 174, 81, 220, 158, 104, 119, 95, 479, 323, 145, 205, 218, 482, 345, 324, 253, 368, 214, 379, 343, 375, 134, 145, 268, 56, 206},
